...
The structure of the code flow is that a given text file is read by each line and looks at each word within the line and stores its location (line number) and position. 
